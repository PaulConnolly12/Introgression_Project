...
do
	...
	echo nohup python $WORKING_DIR$DIV_SCRIPT --d_mel_count_files ${POP_COUNT_FILES[@]} --d_sim_ref_count_file $SIM_REF --d_mel_count_file_path $COUNT_FILE_DIR --d_sim_count_file_path $SIM_DIR --window_size $WIN_SIZE --window_type $WIN_TYPE --out $OUT &> $NOHUP_FILE&
	nohup python $WORKING_DIR$DIV_SCRIPT --d_mel_count_files ${POP_COUNT_FILES[@]} --d_sim_ref_count_file $SIM_REF --d_mel_count_file_path $COUNT_FILE_DIR --d_sim_count_file_path $SIM_DIR --window_size $WIN_SIZE --window_type $WIN_TYPE --out $OUT &> $NOHUP_FILE&
done
